...
def setup_training_loop_kwargs(
    ...
    clipdata   = None, # Reference images for clip loss: <path>, default = None
    ...
    # ------------------------------------------
    # DoRM options: psp_path, clipdata
    # ------------------------------------------

    args.psp_path = psp_path
    args.clipdata = clipdata
    args.vit16 = vit16
    args.vit32 = vit32
    ...
    cfg_specs = {
        ...
        'paper256':  dict(ref_gpus=8,  kimg=100,  mb=64, mbstd=8,  fmaps=0.5, lrate=0.0025, gamma=1,    ema=20,  ramp=None, map=8),
    ...
    if resume != 'noresume':
        args.ada_kimg = 1 # make ADA react faster at the beginning
...
@click.option('--clipdata', help='reference data for clip loss (directory)', metavar='PATH')
@click.option('--vit16', help='Path for ViT-B/16', metavar='PATH')
@click.option('--vit32', help='Path for ViT-B/32', metavar='PATH')
...
@click.option('--psp_path', help='PSP Encoder path for psp loss', metavar='PT')
